...
const AIAssistant: React.FC = () => {
    ...
    const { isAIAssistantOpen, aiAutoPrompt } = state;
        ...
        try {
            ...
            if (response.functionCalls) {
                ...
                if (call.name === 'navigateToPage') {
                    // FIX: Cast pageNumber to number to satisfy loadPage's type requirement.
                    ...
                    // FIX: Cast surahIdentifier to string for safe comparison.
                    ...
                    // FIX: Cast verseKey to string for use in API call.
                    ...
                    // FIX: Cast juzNumber to number for numeric comparisons.
    ...
    return (
        <>
            <button 
                ...
                style={{ bottom: 'calc(5rem + env(safe-area-inset-bottom, 0rem))' }}
            >
