...
const CLR: Record<string, string> = {
    ...
    gear: 'bg-gray-500/10 text-gray-500',
};
type MI = { k: string; t: string; s: string; p: PanelType; n?: boolean };
const SECTIONS: { title: string; items: MI[] }[] = [
    ...
    },
    {
        title: '\u0627\u0644\u062a\u0635\u0641\u062d \u0648\u0627\u0644\u0639\u0628\u0627\u062f\u0629', items: [
            ...
            { k: 'book', t: '\u0623\u062d\u0627\u062f\u064a\u062b \u0646\u0628\u0648\u064a\u0629', s: '\u0623\u062d\u0627\u062f\u064a\u062b \u0645\u0639 \u0627\u0644\u0634\u0631\u062d \u0648\u0627\u0644\u0641\u0648\u0627\u0626\u062f', p: PanelType.Hadith, n: true },
                    ...
                    <div key={sec.title} className="animate-listItemEnter" style={{ animationDelay: `${si * 80}ms` }}>
                        ...
                        <div className="space-y-1">
                            {sec.items.map((item, ii) => (
                                <button key={item.k} onClick={() => actions.openPanel(item.p)}
